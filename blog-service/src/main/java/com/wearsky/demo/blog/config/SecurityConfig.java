package com.wearsky.demo.blog.config;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(requestMatcherRegistry -> requestMatcherRegistry
                        ...
                        .requestMatchers(HttpMethod.GET, "/blog-service/blog/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/blog-service/reply/**").permitAll()
                        .requestMatchers(
